...
def get_symder_apply(sym_model_apply, num_der=1, transform=None, get_dzdt=False):
    func = lambda z, t, params: sym_model_apply(params, z, t)
    dfuncs = dfunc(func, num_der, transform=transform)[1:]

    def symder_apply(params, z, t=0.):
...
def get_model_apply(encoder_apply, symder_apply, 
                    encoder_name='encoder', sym_model_name='sym_model', 
                    hidden_transform=None, get_dzdt=False):
    if get_dzdt:
        def model_apply(params, x, dxdt):
            ...
            if hidden_transform is not None:
                ...
                sym_dzdt_hidden = hidden_transform(z)
            else:
                z_hidden = z
